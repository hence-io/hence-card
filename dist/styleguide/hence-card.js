...
var HenceHook = function HenceHook(targetModel) {
  ...
  return function (e) {
    var model = e.model || {};
    var dataModel = model[targetModel];
...
},{"consoler":12,"lodash/lang/isEqual":78,"lodash/lang/isFunction":79,"lodash/lang/isObject":81}],8:[function(require,module,exports){
/*
  _   _ _____ _   _  ____ _____   _
 | | | | ____| \ | |/ ___| ____| (_) ___
 | |_| |  _| |  \| | |   |  _|   | |/ _ \
...
var polymerIntegrity = function polymerIntegrity(comp) {
  ...
  if (conflictingProps.length) {
    _consoler2['default'].error('Attempted use of reversed Polymer properties names found. Please revise the follow property names in your component to something else.\n      Component in conflict: ' + (comp.is || behaviour) + '\n      Properties in conflict: ' + conflictingProps.join(', '));
  }
